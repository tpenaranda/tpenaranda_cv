...
\extrainfo{33 years old}                 % optional, remove / comment the line if not wanted
...
\section{Summary}
IT professional with more than 9 years of experience developing software.
...
I always keep a positive and proactive attitude, specially when leading interdisciplinary teams and, of course, caring about interpersonal relationships.
Team work is important for me, so as a team member, I always keep in mind I'm being part of one, specially when writing code, using the repo, consuming shared resources or any other task involved in my daily work.
Let's push all together in the same direction, get things done.

\medskip The technologies I've been using the latest years include:
\begin{itemize}
  \item PHP - Laravel 5, Elasticsearch, Composer
  \item Ruby - Rails
  \item HTML5, CSS3, Bootstrap, JavaScript - VueJS, jQuery
    ...
    \begin{itemize}
      \item Harvey (Santa Monica, CA, USA):
        \begin{itemize}
          ...
          \item Responsibilities: New features and API endpoints to feed FE and mobile apps.
      ...
      \item DeringHall (New York, NY, USA):
        \begin{itemize}
          ...
          Laravel 5, AWS, Stripe, Bugsnag, Slack, Github, IronMQ, Jira, VueJS.
        \end{itemize}
...
\cvitem {Tools}{Travis CI, Git, Slack, Elasticsearch, Jenkins, JIRA, SolidWorks, Proteus}
\cvitem {Frameworks}{jQuery, Vue.js, Laravel, Rails, Django, RSpec}
\cvitem {Languages}{PHP, Ruby, Python, ColdFusion, Assembler, C, Perl}
