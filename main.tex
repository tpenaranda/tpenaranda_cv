...
\extrainfo{34 years old}                 % optional, remove / comment the line if not wanted
...
\begin{itemize}
  ...
  \item Elasticsearch, Composer, Redis, WebSockets, jQuery, MySQL, Travis CI, AWS, PHPUnit
    ...
    \begin{itemize}
      \item Redeeem (Los Angeles, CA, USA):
        \begin{itemize}
          ...
          \item Responsibilities: FE, BE, Design, Architecture, Deploys and Services Integrations.
